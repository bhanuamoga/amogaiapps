        ...
        <div className="mx-auto px-3 sm:px-4 py-3 max-w-full sm:max-w-[800px]">
          <div className="flex items-center justify-between">
            <Button 
              variant="outline" 
              size="sm" 
              onClick={() => router.push("/store-ai-chat/woo-prompt-list/new")}
              className="gap-2"
            >
              ...
              <Card key={prompt.id} className="flex flex-col hover:shadow-md transition-shadow">
                ...
                <CardContent className="flex-1 space-y-4">
                  ...
                  <div className="flex items-center justify-end gap-1 border-t pt-4">
                    <Link href={`/store-ai-chat/woo-prompt-list/${prompt.id}`}>
                    ...
                    <Button 
                      variant="outline"
                      size="sm"
                      onClick={() => router.push(`/store-ai-chat/prompt-schedule-logs?promptId=${prompt.id}`)}
                    >
                      <span>View Logs</span>
                    </Button>
                    <Button 
