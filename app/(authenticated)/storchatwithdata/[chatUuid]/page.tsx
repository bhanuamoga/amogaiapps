...
import ChatHeader from "@/app/(authenticated)/storchatwithdata/_components/chat-header";
import ChatBody from "@/app/(authenticated)/storchatwithdata/_components/chat-body";
import ChatInput from "@/app/(authenticated)/storchatwithdata/_components/chat-input";
    ...
    const fetchChat = async () => {
      try {
        ...
        const res = await fetch(
          `/api/storchatwithdata/loadchat?chatUuid=${chatUuid}`,
          { method: "GET" }
        );
