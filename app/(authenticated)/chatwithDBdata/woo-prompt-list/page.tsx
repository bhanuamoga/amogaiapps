        ...
        <div className="mx-auto px-3 sm:px-4 py-3 max-w-full sm:max-w-[800px]">
          <div className="flex items-center justify-between">
            <Button 
              variant="outline" 
              size="sm" 
              onClick={() => router.push("/chatwithDBdata/woo-prompt-list/new")}
              className="gap-2"
            >
              <SquarePen className="h-4 w-4" />
              New Prompt
            </Button>
            <Button variant="ghost" size="sm" onClick={() => router.push("/chatwithDBdata")} className="gap-2">
              <X className="h-4 w-4" />
              <span>Close</span>
            </Button>
          </div>
              ...
              <Card key={prompt.id} className="flex flex-col hover:shadow-md transition-shadow">
                ...
                <CardContent className="flex-1 space-y-4">
                  ...
                  <div className="flex items-center justify-end gap-1 border-t pt-4">
                    <Link href={`/chatwithDBdata/woo-prompt-list/${prompt.id}`}>
                    ...
                    <Button 
                      variant="outline"
                      size="sm"
                      onClick={() => router.push(`/chatwithDBdata/prompt-schedule-logs?promptId=${prompt.id}`)}
                    >
                      <span>View Logs</span>
                    </Button>
                    <Button 
