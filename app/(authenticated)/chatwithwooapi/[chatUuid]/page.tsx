...
import ChatHeader from "@/app/(authenticated)/chatwithwooapi/_components/chat-header";
import ChatBody from "@/app/(authenticated)/chatwithwooapi/_components/chat-body";
import ChatInput from "@/app/(authenticated)/chatwithwooapi/_components/chat-input";
    ...
    const fetchChat = async () => {
      try {
        ...
        const res = await fetch(
          `/api/chatwithwooapi/loadchat?chatUuid=${chatUuid}`,
          { method: "GET" }
        );
